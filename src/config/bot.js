...
client.on("interactionCreate", async (interaction) => {
  ...
  if (interaction.commandName === "sessions") {
    ...
    try {
      ...
      await channel.send(`📌 | OUVERTURE — VALENCE RP FR

━━━━━━━━━━━━━━━━━━━━━━

Le serveur **VALENCE RP FR** est désormais ouvert.

Entre dans un univers RolePlay sérieux et structuré :
• Forces de l’ordre organisées
• Services médicaux présents
• Situations RP variées et immersives
• Communication vocale requise
...
📖 | INFORMATIONS
• Lecture du règlement obligatoire
• RolePlay sérieux attendu
• Équipe staff disponible
• Ambiance correcte et respectueuse

━━━━━━━━━━━━━━━━━━━━━━

REJOINS-NOUS MAINTENANT

Crée ton personnage et développe ton histoire dans un cadre réaliste.
